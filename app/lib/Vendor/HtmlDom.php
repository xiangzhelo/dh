...
final class HtmlDom {
    ...
    public function file_get_html($url, $use_include_path = false, $context = null, $offset = -1, $maxLen = -1, $lowercase = true, $forceTagsClosed = true, $target_charset = self::DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = self::DEFAULT_BR_TEXT, $defaultSpanText = self::DEFAULT_SPAN_TEXT) {
    ...
    protected function prepare($str, $lowercase = true, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT) {
        ...
        $this->root = new \Lib\Vendor\HtmlDomNode($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new \Lib\Vendor\HtmlDomNode($this);
        ++$this->cursor;
